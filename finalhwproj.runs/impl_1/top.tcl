namespace eval ::optrace {
  variable script "C:/finalhw/finalhwproj/finalhwproj.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/finalhw/finalhwproj/finalhwproj.cache/wt [current_project]
  set_property parent.project_path C:/finalhw/finalhwproj/finalhwproj.xpr [current_project]
  set_property ip_output_repo C:/finalhw/finalhwproj/finalhwproj.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/finalhw/finalhwproj/finalhwproj.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/finalhw/finalhwproj/finalhwproj.srcs/constrs_1/new/const_text_gen.xdc
